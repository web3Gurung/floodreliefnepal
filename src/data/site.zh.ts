...
export const zh = {
	...
	give: {
		...
		lede: '选择付款方式。在印度用 UPI，有 Alipay+ 就用该钱包，世界各地可用银行卡，也可银行转账。',
		tabsLabel: '如何付款',
		tabs: [
			{ id: 'upi', label: 'UPI', detail: '若你在印度' },
			{ id: 'alipay', label: 'Alipay+', detail: '扫描 NepalPAY 码' },
		...
		routes: [
			...
			},
			{
				...
				eyebrow: '若你使用 Alipay+',
				heading: '用 Alipay+ 扫描',
				body: '打开 Alipay+ 或兼容钱包，扫描 NepalPAY 码。也可打开政府门户，选择 NepalPAY QR。不要向聊天里发来的二维码付款。',
				caption: 'pmdrf.nchl.com.np 上的 NepalPAY QR',
				alt: '政府门户上的官方 NepalPAY QR，供 Alipay+ 使用',
				action: {
					label: '打开政府门户',
					sub: 'pmdrf.nchl.com.np',
					href: site.official.pmdrf,
	...
	faq: {
		...
		items: [
			...
			{
				q: '能用 Alipay+ 付款吗？',
				a: '可以。打开 Alipay+ 或兼容钱包，扫描汇款区的 NepalPAY 码，或打开 pmdrf.nchl.com.np 并选择 NepalPAY QR。',
			},
			{
	...
	share: {
		...
		post: '波达科西洪灾救援走政府的单一通道。银行卡捐给 pmdrf.nchl.com.np。在印度请扫描 floodreliefnepal.com 上的 Fonepay UPI 码。Alipay+ 用户扫描那里的 NepalPAY 码。聊天里发来的二维码请忽略。',
		copyLabel: '复制帖文',
		copiedLabel: '已复制',
		image: {
			label: '打开分享图',
