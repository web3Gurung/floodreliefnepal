...
export const zh = {
	...
	transparency: {
		...
		eyebrow: '尼泊尔救济',
		heading: '已经到达的每一笔捐款',
		lede: 'Engage Nepal 是美国 501(c)(3) 机构。它在链上收集这些捐款，再转给总理灾害救济基金。本页直接读取收款地址，所以这里的每一个数字，你都可以对照公开记录核对。',
		total: {
			label: '目前已收到',
		...
		merge: {
			...
			dotLabel: '{amount} {token}，{date}。在 Etherscan 打开这笔交易',
			figureLabel: '按资产划分的捐款流入收款地址示意图，转出到基金的位置仍空着。',
			motionNote: '页面打开时，最近的捐款会一次流入资金池。',
		},
		pipeline: {
			heading: '你的钱会怎样走',
			lede: '从你的钱包到基金，共六步。每一步写明发生了什么，以及有什么证明。',
			whatLabel: '发生了什么',
			proofLabel: '有什么证明',
		...
		mosaic: {
			heading: '每一笔捐款都是一块瓷砖',
			lede: '每笔捐款一块，从旧到新。大小按金额，最小的也有下限，方便点按。',
			tileLabel: '{amount} {token}，{date}。在 Etherscan 打开这笔交易',
			unpricedNote: '灰色瓷砖是没有公开价格的资产。',
		},
		media: {
			heading: '外部怎么看',
		...
		verify: {
			heading: '自己核对',
			lede: '上面每个数字都来自公开记录。下面说明如何直接读这份记录。',
